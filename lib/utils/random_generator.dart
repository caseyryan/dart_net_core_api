...
String generateRandomZipCode() {
  return generateRandomRange(100000, 999999).toString();
}

String generateRandomSex() {
  var isMale = _random.nextBool();
  return isMale ? 'MALE' : 'FEMALE';
}

int generateRandomRange(num min, num max) {
  return (min + _random.nextInt((max.toInt() + 1) - min.toInt())).toInt();
}
...
String generateRandomAddress() {
  ...
  var home = generateRandomRange(1, 10000);
...
String getRandomAddress() {
  return '${_getRandomFromList(_addresses)} ${_getRandomFromList(_addresses)} ${generateRandomInt(10000, 999999)}';
}
...
String generateRandomPhone() {
  return '${generateRandomRange(700000000, 799999999).toString()}00';
}
...
DateTime generateRandomDate([
  ...
  var randomYear = generateRandomInt(startYear, endYear);
  var randomMonth = generateRandomInt(1, 12);
  var randomDay = generateRandomInt(1, 28);
